  ...
  var MyOwnController = {
      ...
      sendMailVerify : function(email, objectId){
        var transporter = nodemailer.createTransport({
        		service: 'Gmail',
        		auth: {
        				user: 'trafalgarlaw1443@gmail.com',
        				pass: 'satoshi tajiri'
        		}
        });
      ...
      sendResetPassword : function(email, req, res, callback){
        ...
        this.search(searchCriteria, function(err, list){
          ...
          if(list == ""){
            ...
            var emailTemplate = '<div style="text-decoration: underline;"><a href = "http://54.169.169.163:2000/ipostmo-auth/forgot-password/'+ objectId +'">click to reset your password 1</a></div>';
            var mailOptions = {
              from: '"Ipostmo.com" <ipostmo@gmail.com>', // sender address
              to: 'email,' + email, // list of receivers
              subject: 'Welcome to Ipostmo.com!', // Subject line
